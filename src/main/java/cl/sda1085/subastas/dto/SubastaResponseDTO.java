...
public class SubastaResponseDTO extends RepresentationModel<SubastaResponseDTO> {
    ...
    @Schema(description = "ID del usuario comprador que ganó la subasta.", example = "5", nullable = true)
    private Long idGanador;  //Se llena al finalizar la subasta, el ID ganador será nulo si sigue activo o quedó desierto.
}
