...
public class SubastaController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Subasta eliminada exitosamente."),
    ...
    @Operation(summary = "Registrar subasta verificada (WebClient)", description = "Lógica de negocio avanzada. Conecta síncronamente con el microservicio 'productos' para ver si el producto exista antes de guardar la subasta.")
    @ApiResponses(value = {
